...
@Composable
fun SampahBesarScreen(navController: NavController) {
    val items = listOf(
        "Mesin Cuci", "Kulkas", "Pencuci Piring",
        "Microwave", "Printer", "Televisi"
    )

    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Jenis Sampah Besar", color = Color(0xFF2E7D32), fontWeight = FontWeight.Bold) },
                navigationIcon = {
